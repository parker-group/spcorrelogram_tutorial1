---`r`nencoding: UTF-8`r`ntitle: "Spatial Correlograms: Moranâ€™s I & Gearyâ€™s C by Distance"
...
(e.g., Moranâ€™s I or Gearyâ€™s C) for pairs of points in successive **distance bins** (rings), then plot the statistic
against the bin midpoints. This is conceptually different from a semivariogram (which uses half the average squared
difference).

- **Moranâ€™s I**: correlation-like; > 0 indicates positive autocorrelation, < 0 negative.
- **Gearyâ€™s C**: dissimilarity index; < 1 indicates positive autocorrelation, > 1 negative.
...
## 5) Moranâ€™s I correlogram with permutation p-values
...
## 6) Gearyâ€™s C correlogram (optional)
...
- Moran, P. A. P. (1950). *Notes on continuous stochastic phenomena*. Biometrika 37(1/2), 17â€“23.
- Geary, R. C. (1954). *The contiguity ratio and statistical mapping*. The Incorporated Statistician 5(3), 115â€“146.
