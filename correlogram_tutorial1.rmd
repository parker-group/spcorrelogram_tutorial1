...
> **Why “Standardized z”?** The Moran scatterplot convention is to use standardized values (mean 0, variance 1) on both axes so results are comparable across datasets. For a beginner-friendly variant, you can relabel the axes to “Cell value (±1)” and “Spatial lag (mean of neighbors)” and use unstandardized values.
